...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handler = new FormHandler(form, '/api/search-films', 'GET');
    ...
    handler.setOnSuccess((data, payload) => {
        ...
        paginationContainer = new V1StylePagination(pagination, 1, numberPage);
        ...
        const paginationBottomContainer = new V1StylePagination(paginationBottom, 1, numberPage);
